...
class Task(models.Model):
    ...
    def recent_completed_tasks(self, days):
        return Task.objects.filter(Q(is_completed=True) & Q(completion_date__gt=self.creation_date - timedelta(days=days)))
...
class Exercise(models.Model):
    ...
    def get_exercises_within_duration(cls, min_duration, max_duration):
        return cls.objects.filter(Q(duration_minutes__range=(min_duration, max_duration)))
