...
def find_authors_nationalities():
    ...
    result = [
        f"{a.first_name} {a.last_name} is {a.nationality}" for a in authors
    ]
...
def filter_authors_by_nationalities(recieved_nationality):
    authors = (Author.objects.filter(nationality=recieved_nationality).order_by("first_name", "last_name"))
