...
class Location(models.Model):
    ...
    description = models.TextField()
    is_capital = models.BooleanField(default=True)
...
class HotelRoom(models.Model):
    ...
    room_type = models.CharField(max_length=20, choices=ROOM_TYPE_CHOICE)
...
class Character(models.Model):
    ...
    name = models.CharField(max_length=100)
    class_name = models.CharField(max_length=20, choices=CHOICE)
