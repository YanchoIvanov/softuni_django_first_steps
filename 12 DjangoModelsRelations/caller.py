...
# student1 = Student.objects.create(student_id="M1051", first_name="Alice", last_name="Johnson",
# birth_date="2000-01-15", email="a.johnson@abv.bg")
# student2 = Student.objects.create(student_id="S217", first_name="Bob", last_name="Smith",
# birth_date="2001-05-20", email="bobby@gmail.com")
...
lecturer_profile = LecturerProfile.objects.create(lecturer=lecturer, email="john.doe@university.lecturers.com",
                                                  ...
                                                  office_location="Sofia, Al. Stamobolyiski Str, Faculty of "
                                                                  "Mathematics and Computer Science, Room 101")
